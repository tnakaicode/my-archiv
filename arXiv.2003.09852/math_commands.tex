...
\newcommand{\off}{\textrm{off}} %diagonal matrix
%\newcommand{\dist}{\textrm{d}} %distance function
\newcommand{\din}{d_{\scriptscriptstyle{\textrm{in}}}} %d_in feature dimension
\newcommand{\dout}{d_{\scriptscriptstyle{\textrm{out}}}} %d_out feature dimension
...
\newcommand{\loss}{\mathrm{loss}}%_{\text{ur}}}
\newcommand{\recloss}{\mathrm{loss}_{\text{R}}}%_{\text{ur}}}
\newcommand{\supp}{\mathrm{supp}}
% with colors%MISC
\newcommand{\yl}[1]{{\color{magenta}{\bf[Yaron:} #1{\bf]}}}
\newcommand{\ly}[1]{{\color{blue}{\bf[Lior:} #1{\bf]}}}
\newcommand{\ma}[1]{{\color{cyan}{\bf[Matan:} #1{\bf]}}}
