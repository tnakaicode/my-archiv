...
\subsection*{B. More example feature maps for WaveCNets}
...
%Besides breaking object structures and accumulating noise,
%down-sampling operations may also decrease the shift-invariance of CNNs \cite{azulay2018deep,zhang2019making}.
%Alike anti-aliased CNNs \cite{zhang2019making}, WaveCNets could improve the shift-invariance.
...
\end{figure*}
\subsection*{E. The architectures of SegNet and WaveUNets}
...
\subsection*{F. The amount of multiply-adds in 2D DWT/IDWT}
